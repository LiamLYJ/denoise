...
flags.DEFINE_integer('iter_num', 100, 'how many iter to run in test, in not use_fully_crop mode')
flags.DEFINE_boolean('use_fully_crop', True, 'if use crop and concat policy on testing')
...
def test(FLAGS):
    ...
    truth = truth[...,0]
    truth = tf.placeholder_with_default(truth, [None, None, None], name='dt')
